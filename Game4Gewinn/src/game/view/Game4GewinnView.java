...
public class Game4GewinnView extends PApplet implements IGame4GewinnView {
	private static IGame4GewinnController controller;
	 ...
	 */
	 ...
	 public static Game4GewinnView newClient() {
		 view = new Game4GewinnView();
		 controller = new Game4GewinnController(view, 800, 800);
		 controller.prepareThread();
		 network = "Client";
		 turn = 2;
		 return view;
	 }
	 ...
	 @Override
	 public void setup() {
		controller = new Game4GewinnController(this, width, height);
		controller.prepareThread();
	...
	public void drawClientServerClosedMessage(){
		 ...
		 textSize(20);
		 if(network.contentEquals("Server")) {
			 text("The Client has closed the game. Please restart.", 200, 400);
		 }else {
			 text("The Server has closed the game. Please restart.", 200, 400);
		 }
	 }
	 ...
	 */
	@Override
	public void drawFalsePortMessage() {
		fill(0);
		rect(0, 370, 800, 60);
		fill(255);
		textSize(20);
		text("Port or Ip address is not correct. Please restart", 200, 400);
	}

	/**
	  * Highlight the column where the cursor point.
	  */
	 ...
	 /**
	  * Receive user input from selecting any column.
	  */
	 @Override
	 ...
	 /**
	  * Set the winner of the game. This will be used to determine what to show on end game screen.
	  */
	 ...
	 */
	 public Game4GewinnController getController() {
		 return (Game4GewinnController)controller;
	 }
